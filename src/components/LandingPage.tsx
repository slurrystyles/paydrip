...
function savePendingCheckout(url: string) {
  sessionStorage.setItem("pendingCheckout", url);
}

function getPendingCheckout(): string | null {
  return sessionStorage.getItem("pendingCheckout");
}
...
export default function LandingPage({ user }: { user: User | null }) {
  ...
  const handleCheckout = async (slug: string, cycle: "monthly" | "yearly") => {
    if (slug === "free") {
      if (!user) {
        setShowAuth(true);
        return;
    ...
    if (isIndia) {
      const razorpayPlanMap: Record<string, string> = {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#EEEEEE] font-['Inter'] selection:bg-[#C8FF00] selection:text-[#080808] overflow-x-hidden relative">
      <Helmet>
        <title>
          Paydrip — Get Paid Faster | Invoice Recovery for Freelancers
        </title>
        <meta
          name="description"
          content="Paydrip helps freelancers recover overdue invoices with automated Email, SMS, and WhatsApp reminders. Track payments, score client risk, and collect via UPI or card. Built for India, available worldwide."
        />
        <link rel="canonical" href="https://paydripapp.com/" />
        <meta
          property="og:title"
          content="Paydrip — Get Paid Faster | Invoice Recovery for Freelancers"
        />
        <meta
          property="og:description"
          content="Automate your invoice follow-ups and recover overdue payments with Paydrip. Email, SMS, and WhatsApp reminders. UPI and card payments."
        />
        <meta property="og:url" content="https://paydripapp.com/" />
        <meta
          property="og:image"
          content="https://paydripapp.com/og-image.png"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Paydrip",
            url: "https://paydripapp.com",
            description:
              "Paydrip is an invoice recovery platform for freelancers. Automate payment reminders via Email, SMS, and WhatsApp. Track overdue invoices, score client risk, and collect payments via UPI or card.",
      ...
      >
          ...
          <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 text-left">
              <motion.div
                ...
                className="inline-flex items-center bg-[#111111] border border-[#222222] rounded-full px-3 py-1 text-xs text-[#888888] mb-6"
              >
              ...
              >
                Send once. Paydrip's AI writes personalised recovery sequences
                and delivers them across Email, SMS, and WhatsApp —
                automatically.
              </motion.p>
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                  <button
                    onClick={() =>
                      user ? navigate("/dashboard") : setShowAuth(true)
                    }
              ...
              <div className="relative flex justify-center lg:justify-end">
                ...
                <div className="relative bg-[#111111] border border-[#222222] w-full max-w-[280px] h-[480px] rounded-2xl shadow-2xl overflow-hidden flex flex-col">
                  ...
                  <div className="bg-[#1a1a1a] p-3 flex items-center gap-3 border-b border-[#222222]">
                    <div className="w-7 h-7 bg-[#C8FF00] rounded-lg flex items-center justify-center text-[#080808] text-[9px] font-bold">
                      P
                    </div>
                    <div>
                      <h4 className="text-[#EEEEEE] text-xs font-semibold leading-none">
                        Paydrip Finance
                      </h4>
                  ...
                  <div className="p-4 space-y-4 h-full bg-[#111111] overflow-y-auto">
                    <div className="flex justify-center">
                      <span className="bg-[#1a1a1a] text-[#444444] text-[8px] px-2.5 py-1 rounded-full font-semibold uppercase tracking-widest">
                        Today
                      </span>
                    </div>
                    ...
                    >
                      <p className="text-[10px] text-[#888888] leading-normal font-medium">
                        Hey Arjun Bhatia, just a quick reminder that invoice{" "}
                      ...
                      <div className="mt-2 p-1.5 bg-[#111111] border border-[#222222] rounded-lg flex items-center gap-2">
                        <div className="w-5 h-5 bg-[#C8FF00] rounded flex items-center justify-center text-[#080808] text-[7px] font-bold">
                          P
                        </div>
                        <div className="flex-1 overflow-hidden">
                          <p className="text-[8px] font-semibold text-[#EEEEEE] truncate">
                            paydripapp.com/pay
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <span className="text-[7px] text-[#444444] float-right mt-1 font-mono">
                        10:42 AM
                      </span>
                    </motion.div>
                  </div>
        ...
        >
          <div className="max-w-6xl mx-auto px-6 w-full">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#EEEEEE] max-w-xl leading-tight">
                From invoice to payment, on autopilot.
              </h2>
            </div>
                ...
                {[
                  {
                    ...
                    desc: "Add your org, invite your team. Under 2 minutes.",
                  },
                  {
                    step: "02",
                    title: "Add your clients",
                    desc: "Build your client list. Paydrip auto-scores payment risk.",
                  },
                  {
                    step: "03",
                    title: "Create & send invoices",
                    desc: "Professional invoices with a secure payment portal. UPI QR included.",
                  },
                  {
                    step: "04",
                    title: "AI sequences kick in",
                    desc: "Polite, firm, final — AI writes every follow-up across Email, SMS, and WhatsApp.",
                  },
                  {
                    step: "05",
                    title: "Get paid. Generate receipts.",
                    desc: "Client pays, you verify, PDF receipt in one click.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        i === 0
                          ? "text-[#C8FF00]"
                          : "text-[#444444] group-hover:text-[#C8FF00] transition-colors",
                      )}
                    >
                      {item.step}
                    </div>
                    <div>
                      <h4 className="text-sm font-semibold text-[#EEEEEE] mb-1">
                        {item.title}
                      </h4>
                ...
                <div className="bg-[#080808] border border-[#222222] rounded-xl p-6 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="bg-[#111111] border border-[#222222] rounded-lg p-4 mb-4">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <p className="text-[10px] uppercase tracking-widest font-semibold text-[#888888] mb-0.5">
                          Active Invoice
                        </p>
                        <span className="text-sm font-semibold text-[#EEEEEE] block">
                          Arjun Bhatia
                        </span>
                      </div>
                    ...
                    <p className="text-[10px] text-[#444444] font-mono">
                      Invoice #INV-204 · Overdue 5 days
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    <div className="bg-[#111111] border border-[#222222] px-2 py-2 rounded-lg flex flex-col items-center justify-center text-center">
                      ...
                      <span className="text-[9px] font-semibold text-[#888888] uppercase">
                        Email Sent
                      </span>
                    </div>
                    <div className="bg-[#111111] border border-[#222222] px-2 py-2 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <div className="border border-[#222222] bg-[#111111] rounded-lg p-4">
                    <div className="flex items-center gap-1.5 mb-2">
                      <span className="text-[9px] font-semibold uppercase tracking-wider text-[#888888]">
                        AI-generated · Polite tone
                      </span>
                    </div>
                    <p className="text-xs text-[#888888] leading-relaxed">
                      "We noticed invoice #INV-204 is due today. We kindly
                      request settling payment via the secure portal linked
                      below..."
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="max-w-2xl mx-auto px-6 w-full text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#EEEEEE] mb-10">
              Built in public. Launching soon.
            </h2>

            <div className="bg-[#080808] border border-[#222222] rounded-xl p-10 text-center max-w-xl mx-auto shadow-2xl">
              <div className="flex flex-col items-center">
                {waitlistCount === 0 ? (
                  <span className="text-3xl font-bold text-[#C8FF00] mb-1">
                    Be among the first
                  </span>
                ) : (
              ...
              <p className="text-sm text-[#888888] max-w-sm mx-auto leading-relaxed">
                Paydrip is in active beta. We're onboarding freelancers and
                agencies for early access. Free plan available now — no credit
                card.
              </p>
        ...
        >
          <div className="max-w-6xl mx-auto px-6 w-full">
            <div className="mb-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#EEEEEE] leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch mt-10 max-w-6xl mx-auto w-full">
              ...
              <PricingCard
                ...
                price={
                  billingCycle === "monthly"
                    ? PRICES[currency]?.pro_monthly
                    : PRICES[currency]?.pro_annual
                }
                yearlyPrice={
                  billingCycle === "monthly"
                    ? PRICES[currency]?.pro_annual
              ...
              <PricingCard
                ...
                price={
                  billingCycle === "monthly"
                    ? PRICES[currency]?.ent_monthly
                    : PRICES[currency]?.ent_annual
                }
                yearlyPrice={
                  billingCycle === "monthly"
                    ? PRICES[currency]?.ent_annual
        ...
        >
          <div className="max-w-xl mx-auto px-6 w-full">
            ...
            <p className="text-sm text-[#888888] mt-4 mb-8 max-w-md mx-auto leading-relaxed">
              Join freelancers using Paydrip to automate invoice recovery across
...
function FeatureCard({
  ...
  return (
    <div className="bg-[#111111] border border-[#222222] rounded-xl p-6 hover:border-[#333333] transition-colors flex flex-col justify-between text-left min-h-[180px]">
      <div>
        <div className="text-[#EEEEEE]">{icon}</div>
      ...
      {badge && (
        <span className="text-xs text-[#444444] mt-4 block">{badge}</span>
      )}
    </div>
  );
}
    ...
    <div className="flex flex-col h-full justify-end relative">
      ...
      <div
        className={cn(
          ...
          isPro
            ? "border-[#C8FF00] shadow-[0_0_30px_rgba(200,255,0,0.06)]"
            : "border-[#222222] hover:border-[#333333]",
        )}
      >
        <div>
          <h3 className="text-xs text-[#888888] uppercase tracking-widest font-medium mb-6">
            {name}
          </h3>

          <div className="mb-8">
            <div className="text-4xl font-bold text-[#EEEEEE]">{price}</div>
            {name === "Free" && (
          ...
          <ul className="space-y-3 mb-10">
            {features.map((f: string) => (
              <li
                key={f}
                className="flex items-start gap-2 text-sm leading-normal"
              >

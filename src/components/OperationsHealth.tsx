  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* DLQ Monitoring */}
        <div className="lg:col-span-2 bg-white rounded-[3rem] border border-slate-100 shadow-2xl p-10">
          ...
          <div className="space-y-4">
            {dlqJobs.map((job) => (
              <div key={job.id} className="p-6 bg-slate-50/50 rounded-3xl border border-slate-100 group hover:shadow-xl hover:-translate-y-1 transition-all">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[9px] font-mono text-slate-400 bg-white px-2 py-1 rounded-lg shadow-sm border border-slate-50 uppercase">
                    {job.failure_reason}
                  </span>
                </div>
        ...
        <div className="space-y-8">
           <div className="bg-indigo-600 rounded-[3rem] p-10 text-white shadow-2xl shadow-indigo-100 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-black italic tracking-tighter mb-8 leading-tight">Usage Metering</h3>
                <div className="space-y-8">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                   ...
                   <div>
                     ...
                     <p className="text-xl font-black text-slate-900 tracking-tighter">Observability</p>
                   </div>
                </div>

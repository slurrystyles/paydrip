        ...
        <main className="max-w-3xl mx-auto px-6 py-20">
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-[#888888] leading-relaxed space-y-3">
              <p>
                Paydrip is a subscription-based SaaS product. We want you to be satisfied with your purchase. This policy explains how cancellations and refunds work.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-[#888888] leading-relaxed space-y-3">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>After cancellation, your access continues until the end of your current billing period</li>
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-[#888888] leading-relaxed space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 mb-4">
                ...
                <li>You can cancel anytime and retain access until the billing period ends</li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>Annual subscriptions are eligible for a full refund if requested within 15 days of the original purchase date</li>
                <li>After 15 days, annual subscriptions are non-refundable</li>
                <li>To request a refund, email <a href="mailto:contact@paydripapp.com" className="text-[#C8FF00] hover:underline">contact@paydripapp.com</a> with your account email and payment reference</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-[#888888] leading-relaxed space-y-3">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Lemon Squeezy payments (USD): processed within 5-10 business days</li>
                <li>Razorpay payments (INR): processed within 5-7 business days</li>
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-[#888888] leading-relaxed space-y-3">
              <p>
                We may consider refunds outside this policy in cases of:
              </p>
              <ul className="list-disc list-inside space-y-2">
                <li>Duplicate charges</li>
                <li>Technical issues that prevented access to the service for an extended period</li>
